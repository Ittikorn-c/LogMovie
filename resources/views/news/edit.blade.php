  ...
  <form runat="server" class="form-horizontal" novalidate enctype="multipart/form-data" method="post" action="/news/{{ $news->id }}">
    ...
    <div class="form-group">
      <div class="form-group row">
        ...
        <div class="col-sm-7">
          <input id="title_field" value="{{ old('title') ?? $news->title }}" type="text" name="title" required class="form-control"/>
        </div>
      </div>
      @if ($errors->has('title'))
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <textarea rows="10" id="detail_field" type="text" name="detail" required class="form-control">{{ old('detail') ?? $news->detail }}</textarea>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="references_field" value="{{ old('references') ?? $news->references }}" type="text" name="references" required class="form-control"/>
        </div>
      </div>
